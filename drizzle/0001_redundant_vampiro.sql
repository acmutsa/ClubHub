ALTER TABLE `members` RENAME TO `membership`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_membership`("id", "userId", "clubId") SELECT "id", "userId", "clubId" FROM `membership`;--> statement-breakpoint
